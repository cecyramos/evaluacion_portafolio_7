...
├── ddatos_ejemplo.txt      # Datos para poblar la BD
├── manage.py
...
✅ Commit inicial: Configuración del proyecto, .gitignore y estructura base
✅ Modelos y migraciones: Creación de modelos con relaciones y aplicación de migraciones
✅ CRUD y templates: Implementación de vistas CRUD y templates con Bootstrap
✅ Admin y consultas: Configuración del admin y documentación de consultas ORM/SQL

## Notas Importantes

Base de datos: El archivo db.sqlite3 NO se sube a Git (incluido en .gitignore)
Templates: Ubicados en carpeta templates/ en la raíz del proyecto
Consultas avanzadas: Se ejecutan directamente en el shell de Django, no en vistas web
Bootstrap: Se usa CDN de Bootstrap 5 para estilos básicos
